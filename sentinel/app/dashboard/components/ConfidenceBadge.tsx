...
export function ConfidenceBadge({ score }: ConfidenceBadgeProps) {
  ...
  if (score > 80) {
    ...
    colors = 'bg-green-500/10 text-green-400 border-green-500/20'; // Low confidence of attack = GREEN (safe)
  }
  ...
  return (
    <motion.div 
      ...
      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md border text-xs font-mono font-medium tracking-tight ${colors}`}
    >
      {icon}
